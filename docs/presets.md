...
Keep the bundled `shogi_piece.json` beside `shogi_piece.scad`. It contains
...
Keep historical datasets and their attribution separate from model defaults.
Taikyoku presets and derivative 3MF/STL files are CC BY-SA 4.0, not MIT; see
[LICENSES.md](../LICENSES.md) and [print-file licensing](print-file-licenses.md).
